...
Many problems in applied mathematics can be cast as equations relating functions and their derivatives.  
...
::: {#exm-intro-beam}
The deflection, $y$, of a beam clamped at both ends and under compression by a force $F$ is approximated by the solution to the differential equation 
$y'' + F\sin y = 0$, $y(0) = y(1) = 0$.  
This equation also arises from a conservation of energy.
:::
...
Since $C$ is an arbitrary constant, $y_0 = e^C$ is also arbitrary.
:::
