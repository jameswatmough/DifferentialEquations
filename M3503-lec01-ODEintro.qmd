...
$x' = f(t,x)$, where $f:\Reals\times\Reals^n\to \Reals^n$.

Geometrically, the solution to a system of first order equations,  $x(t)$, describes a curve in $\Reals^n$ parameterized by $t$.  The
