...
Here, to keep consistent with the example of Hirsh, Smale, and Devaney [@hirsch2013Differential Section 1.4] we've rescaled the population by $K$ and rescaled time so that the period of harvesting is one.
:::
