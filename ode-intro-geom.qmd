...
The [OpenStax Calculus][https://openstax.org/books/calculus-volume-3/pages/7-introduction] text covers most of the material we need for first order scalar[^systems] differential equations.  You should have covered all (or at least most) of OpenStax Calculus Volume 1 Chapter 4 in Math 1013.
