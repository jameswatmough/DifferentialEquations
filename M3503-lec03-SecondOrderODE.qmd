...
If we have two linearly independent solutions to the homogeneous problem, we can use these to find a particular solution to the nonhomogeneous problem.
...
$$P \left(u'y'_1 + uy_1^{''} + v'y'_2 + vy_2^{''}\right) + Q\left(uy'_1 + vy'_2\right) + R\left(uy_1 + vy_2\right) = G$$
