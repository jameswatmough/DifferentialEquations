...
$\cos \theta = \frac{1}{2}\left(\exp(i\theta)+\exp(-i\theta)$
and
$\sin \theta = \frac{1}{2i}\left(\exp(i\theta)-\exp(-i\theta)$.
:::
...
$y(t) = c_1\exp(\alpha t) \cos \beta t  + c_2\exp(\alpha t) \sin \beta t$
if the roots of @eq-characteristic are complex.
:::

::: {#exr-2ndorder-linear-1}
