...
A solution to the second order differential equation @eqn-genericode}, is any twice differentiable function $y(x)$
that satisfies @eqn-genericode.
...
Note that we refer to Equation [@eq-genericode] as linear when it is linear in the dependent variable.
